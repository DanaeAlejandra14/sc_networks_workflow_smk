...
seurat_ind <- SplitObject(seurat_obj, split.by = "individualID") #nos lo va a dividir por individual Id
names(seurat_ind) <- paste0(batch_name, "_", names(seurat_ind))#lo une de manera que ahora tebnemos SpecimenID
